...
Browseable Dockerfile output for each scenario — and recipe presets under `recipes/` — is written to [`../example-dockerfiles/`](../example-dockerfiles/) (versioned in git).
